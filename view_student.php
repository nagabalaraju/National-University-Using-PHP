...
<center>
	<h1 style="color:red">STUDENTS DATA </h1>
	<br>
	...
	while($info=$result->fetch_assoc())
	{
		?>
		<tr>
			<td style=" padding-top:5px; padding-bottom:5px; text-align:center; background-color:skyblue; "><?php echo "{$info["USERNAME"]}";?></td>
			<td  style=" padding-top:5px ; padding-bottom:5px; text-align:center; background-color:skyblue; "><?php echo "{$info["PHONE"]}";?></td>
			<td style="  padding-top:5px:; padding-bottom:5px;text-align:center; background-color:skyblue; "><?php echo "{$info["EMAIL"]}";?></td>
			<td style=" padding-top:5px ; padding-bottom:5px; text-align:center; background-color:skyblue; " ><?php echo "{$info["PASSWORD"]}";?></td>
